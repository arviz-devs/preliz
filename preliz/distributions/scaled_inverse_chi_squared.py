...
class ScaledInverseChiSquared(Continuous):
    ...
    def lmoment1(self):
        return ptd_lmoment1(self.nu, self.tau2)

    def lmoment2(self):
        return ptd_lmoment2(self.nu, self.tau2)

    def lmoment3(self):
        return ptd_lmoment3(self.nu, self.tau2)

    def lmoment4(self):
        return ptd_lmoment4(self.nu, self.tau2)
...
@pytensor_jit
def ptd_lmoment1(nu, tau2):
    return ptd_scaledinversechisquared.lmoment1(nu, tau2)


@pytensor_jit
def ptd_lmoment2(nu, tau2):
    return ptd_scaledinversechisquared.lmoment2(nu, tau2)


@pytensor_jit
def ptd_lmoment3(nu, tau2):
    return ptd_scaledinversechisquared.lmoment3(nu, tau2)


@pytensor_jit
def ptd_lmoment4(nu, tau2):
    return ptd_scaledinversechisquared.lmoment4(nu, tau2)
