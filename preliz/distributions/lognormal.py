...
def ptd_lmoment1(mu, sigma):
    return ptd_lognormal.lmoment1(mu, sigma)


@pytensor_jit
def ptd_lmoment2(mu, sigma):
    return ptd_lognormal.lmoment2(mu, sigma)


@pytensor_jit
def ptd_lmoment3(mu, sigma):
    return ptd_lognormal.lmoment3(mu, sigma)


@pytensor_jit
def ptd_lmoment4(mu, sigma):
    return ptd_lognormal.lmoment4(mu, sigma)
