...
def ptd_lmoment1(psi, n, p):
    return ptd_zinegativebinomial.lmoment1(psi, n, p)


@pytensor_jit
def ptd_lmoment2(psi, n, p):
    return ptd_zinegativebinomial.lmoment2(psi, n, p)


@pytensor_jit
def ptd_lmoment3(psi, n, p):
    return ptd_zinegativebinomial.lmoment3(psi, n, p)


@pytensor_jit
def ptd_lmoment4(psi, n, p):
    return ptd_zinegativebinomial.lmoment4(psi, n, p)
